      ...
      <div className="relative z-10 p-6 max-w-md mx-auto">
        ...
        <FuturisticCard accentColor="#c8ff00">
          ...
          <div className="relative border-4 border-[#4169e1] bg-[#0000ff]/40 p-4 mb-6 mt-8">
            ...
            <h2 className="text-4xl font-bold text-[#c8ff00] text-center uppercase tracking-wider">Mi colección</h2>
          </div>
        ...
        <div className="relative mb-8 mt-12">
          <div className="absolute -top-2 left-0 right-0 h-1 bg-[#c8ff00]"></div>
          <div className="border-4 border-[#0000ff] rounded-lg p-4 bg-[#0000ff]/80">
